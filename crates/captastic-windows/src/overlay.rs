...
#[cfg(test)]
use raster::create_ui_font;
use raster::high_contrast_cursor_pixels;
use raster::{
    ...
    measure_ui_text, rgb, scaled_corner_radius, top_down_bitmap_info, TextAlignment,
};
...
use windows::Win32::Graphics::Gdi::{
    AddFontMemResourceEx, BeginPaint, BitBlt, CreateBitmap, CreateCompatibleDC, CreateDIBSection,
    DeleteDC, DeleteObject, EndPaint, GdiFlush, GetDC, GetMonitorInfoW, InvalidateRect,
    MonitorFromRect, ReleaseDC, RemoveFontMemResourceEx, SelectObject, SetStretchBltMode,
    StretchBlt, UpdateWindow, AC_SRC_ALPHA, BLENDFUNCTION, CAPTUREBLT, DIB_RGB_COLORS, HALFTONE,
    HBITMAP, HDC, HGDIOBJ, MONITORINFO, MONITOR_DEFAULTTONEAREST, PAINTSTRUCT, SRCCOPY,
};
...
#[cfg(test)]
use windows::Win32::UI::WindowsAndMessaging::PM_NOREMOVE;
use windows::Win32::UI::WindowsAndMessaging::{
    ...
    GetWindowThreadProcessId, IsWindow, LoadCursorW, PeekMessageW, PostMessageW, PostQuitMessage,
    ...
    CS_HREDRAW, CS_VREDRAW, GWLP_USERDATA, HCURSOR, ICONINFO, IDC_ARROW, IDC_CROSS, IDC_SIZEALL,
    IDC_SIZENESW, IDC_SIZENS, IDC_SIZENWSE, IDC_SIZEWE, MSG, PM_REMOVE, SPI_SETLOGICALDPIOVERRIDE,
    ...
    WM_PAINT, WM_QUIT, WM_RBUTTONDOWN, WM_SETTINGCHANGE, WNDCLASSW, WS_EX_LAYERED,
